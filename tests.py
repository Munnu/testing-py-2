...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def test_games_no_rsvp(self):
        # We need follow_redirects=True because if the user
        # has not RSVPed yet, they should not see the games page
        # And they will be redirected to our index route (see party.py)
        result = self.client.get("/games", follow_redirects=True)
        self.assertIn("We'll have board games, rainbows", result.data)

    def test_games(self):
        # Session Building Stuff
